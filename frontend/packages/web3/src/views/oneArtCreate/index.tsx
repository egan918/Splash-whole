    ...
    if (publicKey) {
      (async function () {
        const result = await axios.post(
          APP_ENDPOINT + '/whitelist/isWhiteListMember',
          {
        ...
        if (!result.data.result) {
          notification.warning({
            message: 'You are not able to mint.',
            description: `We cannot find your address on whitelist. You should register to whitelist to be able to mint`,
